...
export const metadata: Metadata = {
  title: "My Pizzeria - Authentic Italian Pizza",
  description: "Visit My Pizzeria for an authentic Italian pizza experience. Delicious and freshly made with the finest ingredients.",
  openGraph: {
    title: "My Pizzeria - Authentic Italian Pizza",
    description: "Visit My Pizzeria for an authentic Italian pizza experience. Delicious and freshly made with the finest ingredients.",
    url: "",
    siteName: "My Pizzeria",
